...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const formatedTransactions = data.transactions.map((transaction: Transaction) => {
        return {
          ...transaction,
          formattedValue: formatValue(transaction.value),
          formattedDate: new Intl.DateTimeFormat('pt-BR', {}).format(new Date(transaction.created_at))
